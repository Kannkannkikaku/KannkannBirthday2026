#!/usr/bin/env node
/* =========================================================
   Googleフォームの回答CSV → data/messages.json 変換スクリプト
   ---------------------------------------------------------
...
if (typeof require !== 'undefined' && typeof module !== 'undefined' && require.main === module) {
  ...
  const { convertDetailed, toJson } = module.exports;
